...
const ChatInput: React.FC<{ suggestions: String[] }> = ({ suggestions }) => {
  return (
    <>
      {/* Suggestions pannel above input */}
      <div
        className="mt-1 flex w-full gap-x-2 overflow-x-auto whitespace-nowrap text-xs text-slate-600 dark:text-slate-300 sm:text-sm"
      >
        {
